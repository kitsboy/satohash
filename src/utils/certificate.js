 ...
 * Institutional Noir + gold — courtroom-clean, premium title hierarchy.
...
export function downloadCertificate(item) {
  ...
  doc.setFontSize(22)
  doc.setTextColor(15, 23, 42)
  doc.text('BLOCKCHAIN NOTARIZATION', pageW / 2, y, { align: 'center' })
  ...
  const attest = isConfirmed
    ? 'Bitcoin calendar attestation recorded. Independent verification available at the URL above using the SHA-256 hash and proof package.'
    : 'Proof submitted to OpenTimestamps calendars. Status will update to CONFIRMED when Bitcoin-anchored; re-download certificate after confirmation.'
  ...
  doc.text('Generated by Satohash — Bitcoin-Anchored Document Notarization', margin, pageH - 14)
  const host =
