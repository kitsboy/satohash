...
/** Per-page OG image slug under /og. JPEG for landing/stamp/verify/faq/pricing/watch (iMessage). */
const PAGE_OG_SLUG = {
  landing: 'home',
  faq: 'faq',
  stamp: 'stamp',
...
const PAGE_OG_JPEG = new Set(['landing', 'stamp', 'verify', 'faq', 'pricing', 'watch'])
