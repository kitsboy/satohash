    ...
    return (
        ...
        >
            <div style={{ padding: '0 4px' }}>
                <p style={{ fontSize: '16px', color: 'var(--color-text-secondary)', lineHeight: '1.6', marginBottom: '32px', fontWeight: '500' }}>
                ...
                <div style={{
                    ...
                    <button
                        ...
                        style={{
                            ...
                            color: activeTab === 'lightning' ? 'var(--color-primary)' : 'var(--color-text-tertiary)',
                            fontWeight: '800',
                            fontSize: '14px',
                            cursor: 'pointer',
                            display: 'flex',
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ overflow: 'hidden' }}>
                            <div style={{ fontSize: '11px', fontWeight: '900', color: 'var(--color-text-tertiary)', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '4px' }}>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', color: 'var(--color-text-primary)' }}>
                        <ShieldCheck size={18} />
                        <span style={{ fontWeight: '900', fontSize: '14px' }}>Transparency Protocol</span>
                    </div>
                    <p style={{ margin: 0, fontSize: '14px', lineHeight: '1.6', color: 'var(--color-text-secondary)', fontWeight: '500' }}>
