    ...
    <nav className="flex h-full w-64 flex-col border-r border-[var(--border)] bg-[var(--bg-primary)] pt-6">
      ...
      <div className="space-y-4 border-t border-[var(--border)] p-4">
        <button
          ...
          className="group flex w-full items-center justify-between rounded-xl p-3 text-[var(--text-secondary)] transition-all hover:bg-white/5 hover:text-white"
        >
          <div className="flex items-center gap-3">
            <Icons.HelpCircle size={18} className="transition-transform group-hover:rotate-12" />
            <span className="text-[10px] font-bold tracking-widest uppercase">Protocol Guide</span>
          </div>
        </button>
