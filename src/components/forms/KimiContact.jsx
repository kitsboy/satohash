      ...
      >
        <div className="relative shrink-0">
          <img
            src="/kimi-avatar.png"
            alt="Kimi"
            className="h-10 w-10 rounded-full object-cover ring-2 ring-[var(--accent-gold)]/20 transition-all group-hover:ring-[var(--accent-gold)]/40"
          />
      ...
      >
        ...
        <div className="relative flex-1 text-center sm:text-left">
          <div className="flex flex-wrap items-center justify-center gap-2 sm:justify-start">
            ...
            <span className="inline-flex items-center gap-1 rounded-full border border-[var(--accent-gold)]/20 bg-[var(--accent-gold)]/5 px-2 py-0.5 text-[9px] font-bold tracking-wider text-[var(--accent-gold)] uppercase">
