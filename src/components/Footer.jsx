            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 col-span-1 md:col-span-3 gap-12">
                        <div>
                            <h4 className="font-black text-slate-900 uppercase tracking-widest text-xs mb-6">Protocol</h4>
                            <ul className="space-y-4 text-sm font-bold text-slate-500">
                                <li><a href="/#protocol-deep-dive" className="hover:text-orange-500 transition-colors">How it Works</a></li>
                                <li><Link to="/verify" className="hover:text-orange-500 transition-colors">Verifier</Link></li>
                                <li><Link to="/trust" className="hover:text-orange-500 transition-colors">Trust Center</Link></li>
                                <li>
                                    <a href="https://opentimestamps.org/" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 transition-colors flex items-center gap-1.5">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 text-sm font-bold text-slate-500">
                                <li><Link to="/trust" className="hover:text-orange-500 transition-colors">About Us</Link></li>
                                <li><Link to="/" className="hover:text-orange-500 transition-colors">Blog</Link></li>
                                <li><Link to="/protocol-stats" className="hover:text-orange-500 transition-colors">Network Status</Link></li>
                                <li><a href="mailto:careers@satohash.io" className="hover:text-orange-500 transition-colors">Careers</a></li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-4 text-sm font-bold text-slate-500 mb-8">
                                <li><Link to="/legal/privacy" className="hover:text-orange-500 transition-colors">Privacy Policy</Link></li>
                                <li><Link to="/legal/terms" className="hover:text-orange-500 transition-colors">Terms of Service</Link></li>
                                <li><Link to="/legal/crypto-notice" className="hover:text-orange-500 transition-colors">Compliance</Link></li>
                            </ul>
                            <div className="p-4 bg-slate-100/50 rounded-2xl border border-slate-200/50">
                                <p className="text-[10px] text-slate-400 font-bold uppercase leading-relaxed tracking-wider">
                                    Satohash provides mathematical proof of existence via the Bitcoin blockchain. This is not a legal service. For binding legal advice, consult a qualified professional in your jurisdiction.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="pt-12 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-6 text-slate-400 text-sm font-bold">
                    ...
                    <div className="flex items-center gap-2 group">
                        Built with <Heart size={16} className="text-rose-500 fill-rose-500 group-hover:scale-125 transition-transform" /> for <span className="text-slate-900">The Decentralized Web</span>
                    </div>
                </div>
            </div>
        </footer>
