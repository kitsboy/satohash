      ...
      <section className="border-b border-[var(--border)] px-6 pt-20 pb-16">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto max-w-xl text-sm leading-relaxed text-[var(--text-secondary)]">
            Zero-knowledge architecture, client-side hashing, open-source code. Your documents never
            leave your device.
          </p>
        </div>
      </section>
          ...
          {[
            {
              ...
              items: [
                ...
                'Documents never uploaded to any server',
                'No account required for basic stamping',
                'No data retention of file contents'
              ]
            },
            {
              icon: Eye,
              ...
              items: [
                ...
                'No cookies for non-essential functions',
            ...
            },
            {
              ...
              items: [
                ...
                'SQLite database with encrypted WAL mode',
            ...
            },
            {
              ...
              items: [
                ...
                'Session tokens stored in localStorage only'
              ]
            },
            {
              icon: Github,
      ...
      <section className="border-t border-[var(--border)] bg-[var(--bg-secondary)] px-6 py-16">
        <div className="mx-auto max-w-xl text-center">
          ...
          <p className="mb-6 text-sm text-[var(--text-secondary)]">
            If you discover a security vulnerability, please report it responsibly. We commit to
            acknowledging receipt within 48 hours and issuing a fix within 7 days.
          </p>
          <a
