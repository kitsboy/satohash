...
export default function HowItWorks() {
    ...
    return (
        <div className="page" style={{
            ...
            <div className="container container-narrow mx-auto" style={{
                position: 'relative',
                zIndex: 1,
                flex: 1,
                display: 'flex',
                ...
                <div style={{ marginTop: '80px', paddingTop: '80px', borderTop: '1px solid rgba(0,0,0,0.05)' }}>
                    <h2 style={{ fontSize: '24px', fontWeight: '950', textAlign: 'center', marginBottom: '40px', color: '#0f172a' }}>
                        Protocol Deep-Dive
                    </h2>
...
function ProtocolStep({ title, text }) {
    return (
        <div style={{ padding: '24px', background: 'white', borderRadius: '24px', border: '1px solid #e2e8f0' }}>
            <h4 style={{ margin: '0 0 12px 0', fontSize: '14px', fontWeight: '950', color: '#6366f1', textTransform: 'uppercase' }}>{title}</h4>
            <p style={{ margin: 0, fontSize: '15px', color: '#64748b', lineHeight: '1.6', fontWeight: '600' }}>{text}</p>
        </div>
    );
}
