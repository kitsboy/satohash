                ...
                <form onSubmit={handleSubmit} className="animate-fade-in" style={{
                    ...
                    <div style={{
                        ...
                        {formFields.map((field, index) => {
                            ...
                            return (
                                <div key={field.name} style={{ marginBottom: index < formFields.length - 1 ? 'var(--spacing-xl)' : 0 }}>
                                    <label
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        <div style={{
                                            ...
                                            <Icon
                                                size={20}
                                                color={isFocused ? 'var(--color-primary)' : (hasValue ? 'var(--color-text-secondary)' : 'var(--color-text-tertiary)')}
                                            />
                                        </div>
