...
export default function ValueConfirmation() {
  ...
  const steps = ['valueConfirmation.step1', 'valueConfirmation.step2', 'valueConfirmation.step3']
  ...
  return (
    <div className="page">
      <div className="container container-narrow">
        ...
        <Button variant="primary" size="large" onClick={handleStart} style={{ width: '100%' }}>
