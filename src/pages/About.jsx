...
export default function About() {
  return (
    ...
    >
      ...
      >
        ...
        <div className="layout-container relative z-10 text-center">
          <motion.div
            ...
            className="mb-8 inline-flex h-20 w-20 items-center justify-center rounded-3xl bg-[var(--surface-raised)] p-4 text-[var(--accent-active)] shadow-2xl shadow-[var(--accent-active)]/20"
          >
            <BookOpen size={40} />
          </motion.div>
          <motion.h1
      ...
      {/* Abstract Pull Quote */}
      <section className="border-b py-16" style={{ borderColor: 'var(--border)', backgroundColor: 'var(--bg-secondary)' }}>
        <div className="layout-container max-w-4xl px-8">
          <div className="relative">
            <Quote className="absolute -top-10 -left-10 opacity-5" size={120} style={{ color: 'var(--accent-active)' }} />
            <motion.p
              initial={{ opacity: 0 }}
          ...
          <p className="text-sm font-black tracking-widest uppercase italic" style={{ color: 'var(--text-secondary)' }}>
        ...
        <div className="grid grid-cols-1 gap-20 lg:grid-cols-12">
          ...
          <aside className="sticky top-32 hidden h-fit lg:col-span-3 lg:block">
            <nav className="space-y-6">
              <p className="mb-8 text-[10px] font-black tracking-widest uppercase" style={{ color: 'var(--text-secondary)' }}>
                Chapters
              </p>
              {[
          ...
          <article className="space-y-24 lg:col-span-9">
            ...
            <section id="chapter-1" className="space-y-8">
              ...
              <div className="document-paper border-noir relative space-y-6 overflow-hidden p-8 text-lg leading-relaxed font-medium italic shadow-2xl md:p-12" style={{ color: 'var(--text-secondary)' }}>
                <div className="pointer-events-none absolute top-4 right-6 text-[8px] font-black tracking-[0.3em] uppercase italic opacity-10" style={{ color: 'var(--text-primary)' }}>
                ...
                <div className="relative mt-12 overflow-hidden rounded-3xl bg-[var(--surface-raised)] p-10 shadow-2xl">
                  ...
                  <h4 className="mb-6 text-sm font-black uppercase italic" style={{ color: 'var(--accent-active)' }}>
                    The Oracle Statement:
                  </h4>
                  <p className="relative z-10 text-base leading-relaxed italic" style={{ color: 'var(--text-primary)' }}>
            ...
            <section id="chapter-2" className="space-y-8">
              ...
              <div className="document-paper border-noir relative space-y-12 overflow-hidden p-8 shadow-2xl md:p-12">
                ...
                <div className="grid-pattern-slate pointer-events-none absolute inset-0 opacity-[0.01]" />
                <div className="space-y-6 leading-relaxed font-medium italic" style={{ color: 'var(--text-secondary)' }}>
                  <p>
                ...
                <div className="grid gap-8 py-8 md:grid-cols-2">
                  ...
                  >
                    ...
                    <h4 className="mb-3 text-sm font-black uppercase" style={{ color: 'var(--text-primary)' }}>
                      Merkle Roots
                    </h4>
                    <p className="text-xs leading-relaxed font-bold" style={{ color: 'var(--text-secondary)' }}>
            ...
            <section id="chapter-3" className="space-y-8">
              ...
              <div className="document-paper border-noir relative overflow-hidden p-8 shadow-2xl md:p-12" style={{ background: 'var(--bg-secondary)' }}>
                <div className="pointer-events-none absolute top-4 right-6 text-[8px] font-black tracking-[0.3em] uppercase italic opacity-10" style={{ color: 'var(--accent-danger)' }}>
                ...
                <div className="mb-16 text-center">
                  ...
                  <h3 className="mb-6 text-3xl font-black tracking-tighter uppercase italic" style={{ color: 'var(--text-primary)' }}>
                    Sovereignty via Immutability.
                  </h3>
                  <p className="mx-auto max-w-2xl leading-relaxed font-bold italic" style={{ color: 'var(--text-secondary)' }}>
                ...
                <div className="space-y-10 leading-relaxed font-medium italic" style={{ color: 'var(--text-secondary)' }}>
                  <p>
                  ...
                  <p className="rounded-r-3xl border-l-4 border-rose-500 px-12 py-8 shadow-sm" style={{ background: 'var(--surface-raised)', color: 'var(--text-primary)' }}>
            ...
            <section id="chapter-4" className="space-y-8">
              ...
              <div className="document-paper border-noir relative space-y-12 overflow-hidden p-8 shadow-2xl md:p-12" style={{ background: 'var(--bg-secondary)' }}>
                <div className="pointer-events-none absolute top-4 right-6 text-[8px] font-black tracking-[0.3em] uppercase italic opacity-10" style={{ color: 'var(--text-primary)' }}>
                  Judicial_Standard // Level_04
                </div>
                <div className="grid-pattern-slate pointer-events-none absolute inset-0 opacity-[0.01]" />
                <p className="text-lg leading-relaxed font-bold italic" style={{ color: 'var(--text-secondary)' }}>
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  {['ANONYMOUS', 'IMMUTABLE', 'VERIFIABLE', 'FINAL'].map((val) => (
                    ...
                    >
                      <span className="text-[10px] font-black tracking-widest italic" style={{ color: 'var(--accent-active)' }}>
                        {val}
                      </span>
                    </motion.div>
                  ))}
                ...
                <div className="relative overflow-hidden rounded-[2.5rem] p-10 italic" style={{ background: 'var(--surface-raised)' }}>
                  <div className="absolute top-0 right-0 p-8 opacity-5">
                    <Scale size={100} />
                  </div>
                  <p className="relative z-10 text-sm leading-relaxed font-bold" style={{ color: 'var(--text-primary)' }}>
                    ...
                    anchor.&quot;
                    <br />
                    <span className="mt-6 block text-[10px] tracking-widest uppercase" style={{ color: 'var(--text-secondary)' }}>
            ...
            <section id="chapter-5" className="space-y-8">
              ...
              <h2 className="text-noir-primary text-5xl leading-none font-black tracking-tighter uppercase italic">
                The Giving <br />{' '}
                <span className="italic underline decoration-4 underline-offset-8" style={{ color: 'var(--accent-active)', textDecorationColor: 'var(--accent-active)' }}>
                  Machine.
                </span>
              </h2>
              <div className="document-paper border-noir relative space-y-12 overflow-hidden p-8 shadow-2xl md:p-12" style={{ background: 'var(--bg-secondary)' }}>
                ...
                <div className="grid gap-8 md:grid-cols-2">
                  <motion.div
                    ...
                    style={{ borderColor: 'var(--border)', background: 'var(--bg-primary)' }}
                  >
                    <h4 className="mb-4 text-sm font-black uppercase italic" style={{ color: 'var(--text-primary)' }}>
                      Social Subsidization
                    </h4>
                    <p className="text-[11px] leading-relaxed font-bold" style={{ color: 'var(--text-secondary)' }}>
            ...
            <section className="relative overflow-hidden rounded-[4rem] bg-[#0a0d17] p-10 text-white shadow-2xl md:p-16">
              ...
              <div className="relative z-10 grid items-center gap-20 text-left lg:grid-cols-2">
                <div>
                  <div className="mb-8 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[var(--accent-active)] text-white shadow-lg shadow-[var(--accent-active)]/40">
                    <Network size={24} />
                  </div>
                  <h3 className="mb-6 text-4xl leading-tight font-black tracking-tighter text-white uppercase italic">
                    Global Oracle <br /> <span className="text-[var(--accent-active)]">Mesh Topology.</span>
                  </h3>
                  ...
                  <div className="flex gap-4">
                    <div className="rounded-2xl border border-white/10 bg-white/5 p-4 px-6 text-center italic">
                      <div className="mb-1 text-[8px] font-black uppercase" style={{ color: 'var(--accent-active)' }}>
                        Mirror Nodes
                      </div>
            ...
            <section className="border-t pt-16" style={{ borderColor: 'var(--border)' }}>
              <div className="relative overflow-hidden rounded-[3rem] p-12 text-center text-white shadow-2xl md:p-24" style={{ background: 'var(--surface-raised)' }}>
                <div className="relative z-10 mx-auto max-w-2xl">
                  <Shield className="mx-auto mb-10 animate-pulse text-emerald-400" size={64} />
                  <h2 className="mb-8 text-5xl leading-tight font-black tracking-tighter italic" style={{ color: 'var(--text-primary)' }}>
                    Join the <br /> <span style={{ color: 'var(--accent-active)' }}>Final Record.</span>
                  </h2>
                  <p className="mb-12 text-lg leading-relaxed font-bold italic" style={{ color: 'var(--text-secondary)' }}>
                  ...
                  <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                    <Link to="/dashboard">
                      <button className="rounded-2xl px-12 py-5 text-[12px] font-black tracking-[0.2em] uppercase italic transition-all hover:scale-105 hover:shadow-2xl active:scale-95" style={{ background: 'var(--text-primary)', color: 'var(--bg-primary)' }}>
                        Launch Workbench
                      </button>
                    </Link>
                    <Link to="/developer">
                      <button className="rounded-2xl border-2 px-12 py-5 text-[12px] font-black tracking-[0.2em] uppercase italic transition-all hover:bg-white/5 active:scale-95" style={{ borderColor: 'var(--border-bright)', color: 'var(--text-primary)' }}>
                        Access Mesh API
                      </button>
                    </Link>
                  </div>
