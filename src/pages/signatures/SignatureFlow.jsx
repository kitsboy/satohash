      ...
      <div className="container-narrow container">
        ...
        {status === 'success' ? (
          ...
          <>
            ...
            <Card
              style={{ position: 'relative', overflow: 'hidden', marginTop: 'var(--spacing-md)' }}
            >
              ...
              <div className="form-checkbox" style={{ marginTop: 'var(--spacing-lg)' }}>
                <input
                  ...
                  disabled={verifying}
                />
                <label htmlFor="agreeTerms" style={{ fontWeight: '700' }}>
                  {t('signatures.agreeCheckbox')}
                </label>
              </div>
            </Card>
            ...
            >
              {verifying ? (
                ...
                <>
                  <Check size={20} /> {t('signatures.submit')}
                </>
              )}
            </Button>
          </>
