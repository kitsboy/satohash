...
import { Activity, Cpu, Database, Globe, Zap, Clock, ShieldCheck, ArrowUpRight, BarChart3, TrendingDown } from 'lucide-react';
        ...
        <div className="page" style={{ background: '#f8fafc', paddingTop: '100px' }}>
            <div className="container">
                <div style={{ marginBottom: '40px' }}>
                    <div style={{ display: 'inline-flex', padding: '8px 12px', background: 'rgba(99, 102, 241, 0.1)', borderRadius: '20px', color: '#4f46e5', fontSize: '12px', fontWeight: '800', marginBottom: '16px', border: '1px solid rgba(99, 102, 241, 0.2)' }}>
                        <Activity size={14} style={{ marginRight: '6px' }} />
                        NETWORK LIVE REPO
                    </div>
                    <h1 style={{ fontSize: '48px', fontWeight: '950', letterSpacing: '-0.04em', marginBottom: '8px', color: '#0f172a' }}>
                        Protocol Dashboard
                    </h1>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '32px' }}>
                    <Card style={{ padding: '32px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
                            <h3 style={{ margin: 0, fontWeight: '850', fontSize: '20px' }}>Protocol Efficiency</h3>
                        ...
                        <div style={{ height: '300px', display: 'flex', alignItems: 'flex-end', gap: '12px', paddingBottom: '24px' }}>
                            {[40, 65, 30, 85, 45, 90, 60, 75, 55, 80].map((h, i) => (
                                ...
                                >
                                    {i === 5 && (
                                        <div style={{ position: 'absolute', top: '-30px', left: '50%', transform: 'translateX(-50%)', background: '#0f172a', color: 'white', padding: '4px 8px', borderRadius: '4px', fontSize: '10px', fontWeight: 'bold' }}>
                                            PEAK
                                        </div>
                                    )}
                                </motion.div>
                    ...
                    <Card style={{ padding: '32px', background: '#0f172a', color: 'white', border: 'none' }}>
                        <h3 style={{ margin: 0, fontWeight: '850', fontSize: '20px', color: 'white', marginBottom: '24px' }}>System Health</h3>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                            ...
                            <div style={{ marginTop: '16px', padding: '20px', background: 'rgba(255,255,255,0.05)', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.1)' }}>
                                <p style={{ fontSize: '13px', color: '#94a3b8', lineHeight: '1.6', margin: 0 }}>
                                    The Satohash protocol is currently utilizing <strong>3 independent</strong> OTS calendars for maximum redundancy and faster confirmation.
                                </p>
                            </div>
                        </div>
                    </Card>
    ...
    return (
        <Card style={{ padding: '24px', border: '1px solid #e2e8f0' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '12px', background: `${color}10`, display: 'flex', alignItems: 'center', justifyContent: 'center', color: color }}>
                    <Icon size={20} />
                </div>
                <ArrowUpRight size={16} className="text-slate-300" />
            </div>
            <h4 style={{ margin: '0 0 4px 0', fontSize: '13px', fontWeight: '800', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.5px' }}>{label}</h4>
            <div style={{ fontSize: '28px', fontWeight: '950', color: '#0f172a', letterSpacing: '-0.02em', marginBottom: '4px' }}>{value}</div>
