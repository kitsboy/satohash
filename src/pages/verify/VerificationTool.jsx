    ...
    try {
      if (redactedFile) {
        ...
        if (verificationResult.verified) {
          ...
          setStatus('idle')
          alert(
            'Verification Pending: This document proof has been stamped by the calendar servers, but is currently waiting for the next Bitcoin block to be mined. Try upgrading this proof later.'
          )
        } else {
          setStatus('error')
          alert(
      ...
      <div className="container" style={{ flex: 1, maxWidth: '1100px', margin: '0 auto' }}>
        <div className="text-center animate-slide-down" style={{ marginBottom: '60px' }}>
          ...
          >
            ...
            >
              <span style={{ color: 'var(--color-primary)' }}>Protocol Intelligence:</span> Satohash
              verification leverages the immutable nature of the Bitcoin blockchain to provide an
              absolute mathematical audit of your agreements. By providing the{' '}
              <strong style={{ color: '#000' }}>Original PDF</strong> and its corresponding{' '}
              <strong style={{ color: '#000' }}>.ots proof file</strong>, our engine re-calculates
              the SHA-256 hash and reconstructs the Merkle path to verify its presence in a specific
              Bitcoin block. A successful result confirms that the document is identical—to the last
              bit—to the one anchored at that block height, providing indisputable proof of
            ...
            >
              {verificationDetails?.type === 'redacted' ? (
                <>
                  ...
                  <strong>{verificationDetails.revealedCount} verified paragraphs</strong>. Each
                  paragraph was mathematically proven to be part of the original document anchored
                  to the Bitcoin blockchain at root:{' '}
                  <code style={{ fontSize: '10px' }}>{verificationDetails.root}</code>
                </>
              ) : (
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p style={{ fontSize: '14px', color: '#64748b', fontWeight: '800' }}>
                    Tap to select file
                  </p>
                </div>
              </div>
              ...
              <div
                className="animate-slide-up md:col-span-2"
                style={{ animationDelay: '300ms', marginTop: '20px' }}
              >
                <div
                  style={{
                    display: 'flex',
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'left' }}>
                      ...
                      <p
                        style={{ fontSize: '13px', color: '#64748b', fontWeight: '800', margin: 0 }}
                      >
                  ...
                  >
                    <span>
                      {currentStep === 1
                        ? 'Hashing Document...'
                        : currentStep === 2
                          ? 'Reconstructing Merkle Path...'
                          : 'Confirming Bitcoin Block...'}
                    </span>
