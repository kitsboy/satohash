...
**Family widgets (2026-09-15):** live stamps verified (katoa/motopass/sherpacarta/tadbuy=2, giveabit=3). Giveabit widget is `/tools`. HQ was not zeros. Do **not** rebuild Satohash API. SoT: `docs/FAMILY-API.md`.
